...
$(document).ready(function(){			
    ...
    new AjaxUpload('upload_button', {
        ...
        onSubmit: function(file, extension) {
            ...
            if(scorm_api){
                ...
                this.setData({
                    'student_mail' : 'boris.fritscher@unil.ch',
                    'student_name' : 'boris',
                    'assignment' : 'p01'
                });
            }
    ...
    $('#webexplorer_button').click(function(){
        $.ajax({
          ...
          data:  {'student_mail' : 'boris.fritscher@unil.ch',
                        'student_name' : 'boris',
                        'assignment' : 'tp1',
                        'webexplorer': true},
...
<?php $html->scriptEnd();?>
<div id="text">
<h1>DEV VERSION <span>TP</span> Corrector</h1>
<h2>Fichier</h2>
<input type="button" id="upload_button" value="Valider un fichier" />
<input type="button" id="webexplorer_button" value="Valider la page webexplorer" />
<h2>Résultat</h2>
